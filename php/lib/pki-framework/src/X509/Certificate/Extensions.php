...
namespace TrueLayer\SpomkyLabs\Pki\X509\Certificate;
...
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\AuthorityKeyIdentifierExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\BasicConstraintsExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\CertificatePoliciesExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\CRLDistributionPointsExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\ExtendedKeyUsageExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\Extension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\InhibitAnyPolicyExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\IssuerAlternativeNameExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\KeyUsageExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\NameConstraintsExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\PolicyConstraintsExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\PolicyMappingsExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\SubjectAlternativeNameExtension;
use TrueLayer\SpomkyLabs\Pki\X509\Certificate\Extension\SubjectKeyIdentifierExtension;
use Traversable;
use function count;
